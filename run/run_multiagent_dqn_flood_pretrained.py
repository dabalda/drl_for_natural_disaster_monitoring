...
def main():
    log_dir = '../../drl_for_surveillance_runs/flood/indiv/dqn/pretrained/'
    pretrained_model_name = 'dqn_model.pkl'
    ...
    model = DQN.load('../../' + 'pretrained_models/' + pretrained_model_name, env=env)
